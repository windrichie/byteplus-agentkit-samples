...
class Status(BaseModel):
    ...
    message: str = Field(description="Empty when the run succeeds; otherwise the error message")
...
class EvaluationList(BaseModel):
    evaluation: EvaluationResult = Field(..., description="The evaluation result")
