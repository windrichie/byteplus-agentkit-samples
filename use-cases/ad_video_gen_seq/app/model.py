...
if os.getenv("USE_SYSTEM_SSL_TRUSTSTORE", "true").lower() in {
    "1",
    "true",
    "yes",
    "on",
    ...
    try:
        ...
        logger.info("Using system SSL trust store for Ark model requests.")
    except Exception as e:
        logger.warning(f"Unable to enable system SSL trust store: {e}")
...
def _get_content(
    ...
    for part in parts:
        ...
        elif part.file_data:  # file_id and file_url
