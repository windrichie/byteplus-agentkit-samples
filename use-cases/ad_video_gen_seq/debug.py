...
async def import_session(session_service, app_name, user_id, file_path):
    with open(file_path, "r", encoding="utf-8") as f:
        ...
        # Create a new session and copy state
...
if __name__ == "__main__":
    prompt = "Help me generate a promotional video (product showcase video) for a bayberry beverage. Image asset: https://ark-tutorial.tos-cn-beijing.volces.com/multimedia/%E6%9D%A8%E6%A2%85%E9%A5%AE%E6%96%99.jpg Two first-frame images per shot, two videos per shot."
