...
Step 0: Install/upgrade AgentKit SDK (CLI)
...
1.  Visit the BytePlus AgentKit Console
2.  Open **Runtime** and locate the deployed agent `storybook_illustrator`
3.  Get the runtime endpoint domain name and API Key
